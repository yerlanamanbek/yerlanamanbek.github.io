...
excerpt: "<img src='/images/publications/Appl_PINN_2phase_var_dif.png' style='float:left;width:293px;height:120px;'>"
date: 2025-05-30
...
compared to using a constant diffusion coefficient."
 ...
 <figure>
  ...
  <figcaption> PINN solution with diffusion \(\epsilon = 0.04x^2 + 0.05x + 0.0015\)</figcaption>
  </div>
  </p>
</figure>
