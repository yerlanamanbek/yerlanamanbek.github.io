...
This page provides regular updates of COVID-19 model outcomes for the Post-Soviet states. The dynamics simulation uses the SIERPQ (Susceptible-Protected-Exposed-Infectious-Quarantined-Recovered-Dead) model. 
